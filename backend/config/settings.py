...
# These values are injected by Docker in local development and should never be
# committed as real production secrets.
SECRET_KEY = os.environ.get("DJANGO_SECRET_KEY", "mobilend-insecure-development-only-secret")
...
# PostgreSQL runs in the separate `db` Docker service. Docker's internal DNS
# resolves the service name `db` to that container.
DATABASES = {
    "default": {
        "ENGINE": "django.db.backends.postgresql",
        "NAME": os.environ.get("POSTGRES_DB", "mobilend"),
        "USER": os.environ.get("POSTGRES_USER", "mobilend"),
        "PASSWORD": os.environ.get("POSTGRES_PASSWORD", "mobilend-local-password"),
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": (
        ...
        "Authentication, customer management, and (in progress) the lending domain."
    ),
    "VERSION": "1.0.0",
